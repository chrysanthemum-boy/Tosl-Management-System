...
import me.fann.modules.system.service.dto.DeptDto;
import me.fann.modules.system.service.dto.DeptQueryCriteria;
import me.fann.utils.*;
import me.fann.modules.system.repository.DeptRepository;
import me.fann.modules.system.service.DeptService;
import me.fann.modules.system.service.mapstruct.DeptMapper;
import me.fann.utils.enums.DataScopeEnum;
...
public class DeptServiceImpl implements DeptService {
    ...
    public void download(List<DeptDto> deptDtos, HttpServletResponse response) throws IOException {
        ...
        for (DeptDto deptDTO : deptDtos) {
            ...
            map.put("城市名称", deptDTO.getName());
            map.put("城市状态", deptDTO.getEnabled() ? "启用" : "停用");
    ...
    public void verification(Set<DeptDto> deptDtos) {
        ...
        if(userRepository.countByDepts(deptIds) > 0){
            throw new BadRequestException("所选城市存在用户关联，请解除后再试！");
        }
        if(roleRepository.countByDepts(deptIds) > 0){
            throw new BadRequestException("所选城市存在角色关联，请解除后再试！");
        }
    }
